...
/** The Atrium mark: a simple doorway/arch — the entrance hall the product
 * is named for. Single stroke, no fill, sized by its container via CSS. */
export const logoMark =
  '<svg class="logo-mark" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" ' +
  'fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" ' +
  'stroke-linejoin="round" aria-hidden="true"><path d="M5 21V11a7 7 0 0 1 14 0v10" /></svg>';
